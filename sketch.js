var sketch = function(p) {
      ...
      var susBoxes = document.getElementsByClassName("susBox");
      var susModifiers = document.getElementsByClassName("susMods");
      ...
      function makeChord(r, q) {
            ...
            for (i = 0; i < 4; i++) {
                  var mod;
                  var list = susModifiers[i];
                  if (susBoxes[i].checked) {
                        console.log("is clicked");
                        susCount++;
                        mod = parseInt(list[list.selectedIndex].value);
                        switch (i) {
                              case (i = 0):
                                    chordInfo.notes.push(rootNum + 11 + mod)
                                    break;
                              case (i = 1):
                                    chordInfo.notes.push(rootNum + 14 + mod)
                                    break;
                              case (i = 2):
                                    chordInfo.notes.push(rootNum + 18 + mod)
                                    break;
                              case (i = 3):
                                    chordInfo.notes.push(rootNum + 20 + mod)
                                    break;
                        }
                  }
